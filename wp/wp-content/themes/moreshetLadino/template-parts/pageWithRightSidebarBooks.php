...
get_header(); ?>
	...
	<div id="secondary" class="widget-area widget-area-b" role="complementary">
		...
		<a class="katava fancybox" href="<?php echo get_template_directory_uri(); ?>/images/katava.jpg" rel="group" ><img src="<?php echo get_template_directory_uri(); ?>/images/katava.jpg" alt="katava"></a>
